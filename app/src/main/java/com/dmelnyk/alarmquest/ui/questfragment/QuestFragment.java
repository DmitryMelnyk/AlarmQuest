...
//    @BindView(R.id.question) TextView question;
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            // updated NOP
            // QuestFragment can be attached to Fragment not only to Activity
//            throw new ClassCastException(context.toString()
//                    + " must implement OnImageClickListener");
        }
    }

    public void setCallback(SolvedQuestCallbackListener callback) {
...
//            answer4.setTextColor(ContextCompat.getColor(getContext(), android.R.color.black));
    ...
    public void callbackListen(boolean isCorrectAnswer) {
        ...
        callback.solvedQuestion(isCorrectAnswer);
    }
